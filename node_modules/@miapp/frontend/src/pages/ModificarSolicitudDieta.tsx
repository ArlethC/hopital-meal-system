/*
    Archivo: ModificarSolicitudDietas.tsx
    Descripcion: Pantalla para modificar las solicitudes de dietas.
    ...
    const handleSearch = async (page: number = 1) => {
        ...
        try {
            if (datos) {
                ...
                const response = await obtenerSolicitudesMod(datos, params);
            ...
            {search && (
                (!solicitudes || solicitudes.length === 0) ? (
                    ...
                    <DetalleOrdenDieta
                        ...
                        mapPaciente={mapDetalleOrdenToPacienteModificar}
                        habilitarAdvertenciaCambios={true}
...
export default DietasModifyPage;